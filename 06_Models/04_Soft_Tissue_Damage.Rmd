...
```{r}
rf_ck_pred <- unname(predict(rf, poly_ck))
R2_ck_rf <- 1 - (sum((poly_ck$ck - rf_ck_pred)^2) / sum((poly_ck$ck - mean(poly_ck$ck))^2))
print(paste("Random Forest In-sample R^2 for ck:", round(R2_ck_rf, 3)))
```
