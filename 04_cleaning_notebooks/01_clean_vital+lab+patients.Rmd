...
The units look nice and standardized.
*Data Quality Note:* The client confirmed we should keep only the last measurement when duplicates exist, as these likely represent corrections.
...
* *Quick (manuell) #* is weird, let's check.
```{r lab3}
